...
const staticPages: SeoPageConfig[] = [
  { path: '/', title: 'AI Credit Report Analysis & Credit Software', description: 'Analyze credit reports, identify potential reporting issues, organize dispute letters, or manage client workflows with FixMy.Money credit intelligence software.', primaryKeyword: 'credit report analysis software', secondaryKeywords: ['credit intelligence software', 'credit repair software', 'credit repair business software'], type: 'product', updatedAt: '2026-08-29', priority: 1, changeFrequency: 'weekly' },
  ...
  { path: '/credit-repair-automation', title: 'Credit Repair Automation Software', description: 'Automate repeatable credit repair agency workflows while keeping human review, client authorization, evidence, approvals, and compliance records in control.', primaryKeyword: 'credit repair automation', secondaryKeywords: ['automated credit repair', 'credit repair software', 'credit dispute software'], type: 'product', updatedAt: UPDATED_AT, priority: .9 },
  { path: '/what-is-fixmy-money', title: 'What Is FixMy.Money?', description: 'FixMy.Money is business software for credit repair professionals. Learn how it helps agencies manage report review, disputes, billing, approvals, and client workflows.', primaryKeyword: 'what is FixMy.Money', secondaryKeywords: ['fixmy.money company', 'credit repair software'], type: 'product', updatedAt: UPDATED_AT, priority: .85 },
  ...
  { path: '/alternatives/credit-repair-cloud', title: 'Credit Repair Cloud Alternative', description: 'Compare the workflow capabilities agencies should evaluate when choosing a Credit Repair Cloud alternative.', primaryKeyword: 'Credit Repair Cloud alternative', secondaryKeywords: ['credit repair software comparison'], type: 'product', indexStatus: 'noindex', updatedAt: '2026-08-29', priority: .2 },
