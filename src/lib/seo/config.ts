...
const staticPages: SeoPageConfig[] = [
  ...
  { path: '/pricing', title: 'Credit Repair Software Pricing', description: 'Compare published FixMy.Money monthly plan prices. New paid activation is on hold pending billing and legal review.', primaryKeyword: 'credit repair software pricing', secondaryKeywords: ['credit repair business software pricing'], type: 'product', updatedAt: UPDATED_AT, priority: .9 },
  ...
  { path: '/credit-repair-cloud-alternative', title: 'Credit Repair Software Product Tour', description: 'Review the currently available FixMy.Money workflow capabilities.', primaryKeyword: 'Credit Repair Cloud alternative', secondaryKeywords: ['credit repair software comparison'], type: 'product', updatedAt: UPDATED_AT, priority: .85 },
