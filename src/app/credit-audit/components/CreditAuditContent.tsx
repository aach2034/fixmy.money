...
interface AuditResult {
  ...
  priorityItems: { id: string; creditor: string; type: string; bureau: string; amount: string; reason: string; strength: string; anomaly: string; findings: AnomalyFindingView[] }[];
