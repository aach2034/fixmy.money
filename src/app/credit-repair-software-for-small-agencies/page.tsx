...
export const metadata: Metadata = {
  ...
  description: 'Affordable credit repair software for small agencies and solo operators. Manage clients, disputes, and billing. 14-day free trial.',
      ...
      <main>
        ...
        <section className="py-20 bg-blue-600">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg text-blue-50 mb-8">14-day free trial. No credit card required. Cancel anytime.</p>
