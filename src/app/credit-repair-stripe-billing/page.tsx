...
export const metadata: Metadata = {
  ...
  description: 'Automate billing for credit repair agencies with Stripe integration. Charge clients, manage subscriptions, and track revenue from one platform. 14-day free trial.',
