    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }}>
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-slate max-w-none text-sm leading-relaxed space-y-6">
          ...
          <p className="text-slate-600">Subscription charges purchase access to the FixMy.Money software for the selected subscription period; they are not fees for improving any consumer's credit or producing a particular credit outcome. Published subscriptions are billed monthly. You may cancel from your billing settings, and trial periods are subject to the terms presented at signup. Payments are processed securely by Stripe.</p>
