...
export const metadata: Metadata = {
  ...
  description: 'CROA-compliant audit logging for credit repair agencies. Track all user actions, document compliance, and maintain records. 14-day free trial.',
...
{ q: 'How long are audit logs retained?', a: 'Audit logs are retained for the life of your account. Export logs anytime for compliance documentation.' },
{ q: 'Can I filter audit logs?', a: 'Yes. Filter by user, date, action type, client, and more. Search for specific events instantly.' },
{ q: 'Are audit logs CROA-compliant?', a: 'FixMy.Money provides audit logging tools to support compliance. Users remain responsible for their own compliance.' }];


export default function CreditRepairAuditLogPage() {
  return (
      ...
      <main>
        ...
        <section className="py-20 bg-gradient-to-br from-slate-900 to-blue-950">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="text-5xl font-extrabold text-white mb-4 leading-tight">
              Credit Repair Audit Log Software
            </h1>
            <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
              Track every action in your agency. Maintain CROA-compliant audit trails and export records for compliance documentation.
            </p>
        ...
        <section className="py-20 bg-slate-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-slate-900 mb-12 text-center">Audit Log Features</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
              { title: 'Complete Activity Tracking', desc: 'Every action logged with timestamp, user, and details.' },
              { title: 'User Action History', desc: 'See who did what, when, and why for every action.' },
              { title: 'Searchable Logs', desc: 'Filter by user, date, action type, client, and more.' },
              { title: 'Export Compliance Records', desc: 'Export audit logs for compliance audits and documentation.' },
              { title: 'Role-Based Access', desc: 'Control who can view audit logs based on role.' },
              { title: 'Long-Term Retention', desc: 'Audit logs retained for the life of your account.' }].
              map((f, i) =>
        ...
        <section className="py-20 bg-blue-600">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl font-bold text-white mb-4">Maintain CROA-compliant audit trails</h2>
