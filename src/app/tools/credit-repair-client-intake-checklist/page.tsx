...
export const metadata: Metadata = {
  title: 'Credit Repair Client Intake Checklist | Free Tool | FixMy.Money',
  description: 'Free client intake checklist for credit repair agencies. Ensure you collect all necessary information from new clients.',
  alternates: { canonical: 'https://fixmy.money/tools/credit-repair-client-intake-checklist' },
  openGraph: {
    title: 'Credit Repair Client Intake Checklist | Free Tool | FixMy.Money',
    description: 'Free client intake checklist for credit repair agencies.',
    url: 'https://fixmy.money/tools/credit-repair-client-intake-checklist',
    type: 'website',
  },
};
...
const checklist = [
  ...
  'Credit report authorization and consent',
  'Service agreement signed',
  'Pricing and payment terms confirmed',
  'Credit report obtained from all three bureaus',
  'Initial credit analysis completed',
  'Dispute strategy documented',
  'Payment method on file',
  'Communication preferences recorded',
  'Compliance documentation filed',
];

export default function ClientIntakeChecklistPage() {
  return (
    <div className="min-h-screen bg-white" style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }}>
      ...
      <section className="bg-gradient-to-br from-slate-950 to-[#0d1f3c] py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl font-extrabold text-white mb-5 leading-tight">
            Credit repair client intake checklist
          </h1>
          <p className="text-xl text-slate-300 mb-6 max-w-2xl mx-auto">
            Ensure you collect all necessary information from new clients.
          </p>
          <div className="bg-slate-800/60 border border-slate-700/60 rounded-xl px-5 py-3 mb-8 max-w-2xl mx-auto">
            <p className="text-xs text-slate-400">
              This checklist is for educational purposes. Consult with a qualified attorney regarding required disclosures and compliance.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-slate-50">
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-2xl border border-slate-200 p-8">
            <h2 className="text-2xl font-bold text-slate-900 mb-6">Client Intake Checklist</h2>
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-6 flex gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-amber-700 leading-relaxed">
                This checklist is for educational purposes. CROA and FCRA have specific requirements for client disclosures and agreements. Consult with a qualified attorney to ensure your intake process complies with all applicable laws.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-4 bg-slate-900 text-center">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-3xl font-extrabold text-white mb-4">Streamline your client onboarding</h2>
          <p className="text-slate-400 mb-8">FixMy.Money automates client intake and onboarding workflows.</p>
