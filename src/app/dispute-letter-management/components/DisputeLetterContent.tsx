    ...
    <div className="page-container space-y-5">
      {autoGeneratedCount > 0 && (
        <div className="rounded-2xl border border-violet-200 bg-violet-50 p-5">
          <p className="font-bold text-violet-900">{autoGeneratedCount} existing draft record{autoGeneratedCount === 1 ? '' : 's'} loaded</p>
          <p className="text-sm text-violet-700 mt-1">Automatic draft generation is disabled. Verify every fact and edit any existing draft before mailing.</p>
        </div>
      )}
      {/* Header */}
          ...
          <div className="bg-white rounded-2xl w-full max-w-4xl max-h-[92vh] flex flex-col shadow-2xl">
            ...
            <div className="flex-1 overflow-auto bg-slate-100 p-4 sm:p-8">
              {previewLetter.needsRegeneration ? (
                ...
                <>
                  {previewLetter.autoGenerated && previewLetter.aiRationale && <div className="mx-auto max-w-[8.5in] mb-4 rounded-xl border border-violet-200 bg-violet-50 p-4"><p className="text-sm font-bold text-violet-900">Historical draft rationale</p><pre className="mt-2 whitespace-pre-wrap font-sans text-sm leading-6 text-violet-800">{previewLetter.aiRationale}</pre><p className="text-xs text-violet-600 mt-3">Automatic generation is disabled. This historical explanation is for internal review and is not printed inside the letter.</p></div>}
