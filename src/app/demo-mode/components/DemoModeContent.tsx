        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl p-6 max-w-sm mx-4 shadow-xl">
            ...
            <p className="text-sm text-slate-600 mb-4">
              This action is disabled in demo mode. Start a free trial to use all features with your real clients.
            </p>
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col" style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }}>
      ...
      <div className="bg-slate-900 text-white px-4 py-2 flex items-center justify-between sticky top-0 z-50">
        <div className="flex items-center gap-3">
          <button className="lg:hidden text-slate-400 hover:text-white" onClick={() => setMobileNavOpen(!mobileNavOpen)}>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/homepage" className="text-slate-400 hover:text-white text-xs flex items-center gap-1">
            <X size={14} /> Exit Demo
          </Link>
        </div>
      </div>
          ...
          <div className="fixed inset-0 z-40 lg:hidden">
            ...
            <aside className="absolute left-0 top-0 bottom-0 w-56 bg-white border-r border-slate-200 flex flex-col">
              <div className="p-3 border-b border-slate-100 flex items-center justify-between">
                ...
                <button onClick={() => setMobileNavOpen(false)}><X size={16} className="text-slate-400" /></button>
              </div>
              <nav className="flex-1 overflow-y-auto py-2 px-2 space-y-0.5">
                {NAV_ITEMS.map(item => {
                  const Icon = item.icon;
